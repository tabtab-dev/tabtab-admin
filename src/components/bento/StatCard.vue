...
<template>
  ...
  >
    <!-- 背景渐变 -->
    <div
      class="absolute inset-0 bg-gradient-to-br opacity-50" :class="[theme.gradient]"
    />
      ...
      <div class="flex items-start justify-between">
        ...
        <div class="flex-1 min-w-0">
          ...
          <div class="flex items-center gap-2 mb-3">
            <div class="p-2 rounded-lg" :class="[theme.bg]">
              <component :is="icon" class="h-4 w-4" :class="[theme.icon]" />
            </div>
          ...
          <div v-if="trend !== 0" class="flex items-center gap-1 mt-2">
            <component
              ...
              class="h-3 w-3" :class="[isPositive ? 'text-emerald-500' : 'text-red-500']"
            />
            <span class="text-xs font-medium" :class="[isPositive ? 'text-emerald-500' : 'text-red-500']">
              {{ Math.abs(trend) }}%
            </span>
